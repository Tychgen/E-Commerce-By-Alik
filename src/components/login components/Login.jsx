        ...
        <div className="card bg-dark text-white" style={{ borderRadius: '1rem' }}>
          <div className="card-body p-5 text-center">
            ...
            <div className="mb-md-5 mt-md-4 pb-5">
              ...
              <p className="text-white-50 mb-2">Welcome to the E-Shop by Alik!</p>
              ...
              <button className="btn btn-outline-light btn-lg px-5" onClick={handleLogin} onKeyDown={handleKeyLogin}>Login</button>
              ...
              <div className="d-flex justify-content-center text-center mt-4 pt-1">
                ...
                <NavLink NavLink to="/" className="text-white"><FaGoogle/></NavLink>
              </div>
